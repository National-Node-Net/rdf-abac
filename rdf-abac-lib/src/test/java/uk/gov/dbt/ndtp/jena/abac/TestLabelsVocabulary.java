...
/** Tests for {@link Labels#vocabulary(LabelsStore, String)}. */
public class TestLabelsVocabulary {
    ...
    /** The deny label is never added: it is a refusal, so nothing may be permitted to see it. */
    ...
    /** What the sparse write path produces: everything ingested at the default, so nothing stored. */
    ...
    /** The {@code authz:labels <file:...>} route. Patterns must be concrete; wildcards are rejected. */
