...
public class DatasetGraphPBAC extends DatasetGraphWrapper {
    ...
    /** API: use {@link PBAC#authzDataset} */
    public DatasetGraphPBAC(DatasetGraph base, String accessAttributes,
    ...
    public DatasetGraph getData() {
        ...
        // Give the operation a meaningful name for DatasetGraphPBAC
        return get();
    }
