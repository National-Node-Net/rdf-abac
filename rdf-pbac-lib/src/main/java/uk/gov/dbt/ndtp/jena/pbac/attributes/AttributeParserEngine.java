...
import static uk.gov.dbt.ndtp.jena.pbac.attributes.syntax.AEX.KW_FALSE;
import static uk.gov.dbt.ndtp.jena.pbac.attributes.syntax.AEX.KW_TRUE;
...
import uk.gov.dbt.ndtp.jena.pbac.attributes.syntax.tokens.TokenType;
import uk.gov.dbt.ndtp.jena.pbac.attributes.syntax.tokens.Tokenizer;
import uk.gov.dbt.ndtp.jena.pbac.attributes.syntax.tokens.TokenizerABAC;
...
//                throw new AttributeSyntaxError("Unexpected end to attribute hierarchy");
    ...
    private AE_Bracketed getAeBracketed() {
    ...
    private AE_Attribute readAttribute() {
        ...
        if ( peek.isWord() || peek.isString() ) {
            ...
            if (str.equals(KW_TRUE) || str.equals(KW_FALSE)) {
